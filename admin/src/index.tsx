        ...
        advanced: [
          {
            sectionTitle: {
              id: getTrad(
                'strapi-color-picker.options.advanced.packages.list.title'
              ),
            ...
            items: iconPacks.map((pack) => {
              return {
                ...
                // description: {
                //   id: getTrad(
                //     'strapi-color-picker.options.advanced.packages.list.description'
                //   ),
                //   defaultMessage: 'Whether to include this icon package',
                // },
              };
            }),
            // 'bootstrap',
